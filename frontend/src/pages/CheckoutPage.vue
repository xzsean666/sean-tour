...
<template>
  ...
  >
    ...
    <p class="mt-2 text-sm text-slate-600">
      Booking ID:
      <span class="font-semibold text-slate-900">{{ bookingId }}</span>
    </p>
  </section>
  ...
  <Message v-if="copySuccess" severity="success" class="mt-4">{{
    copySuccess
  }}</Message>
      ...
      <template #content>
        <dl class="space-y-3 text-sm">
          ...
          <div class="flex items-center justify-between gap-3">
            ...
            <dd class="font-medium text-slate-900">
              {{ checkout.travelerCount }}
            </dd>
          </div>
          <div class="flex items-center justify-between gap-3">
            <dt class="text-slate-500">Date</dt>
            <dd class="font-medium text-slate-900">
              {{ checkout.travelDateRange }}
            </dd>
          </div>
          <div
        ...
        <div class="space-y-4 text-sm">
          ...
          <div class="flex items-center justify-between gap-3">
            ...
            <Tag
              ...
              :severity="checkout.paymentStatus === 'PAID' ? 'success' : 'warn'"
            />
          </div>
          ...
          <p class="text-slate-500">
            This intent expires in {{ checkout.expiresInMinutes }} minutes.
          </p>
